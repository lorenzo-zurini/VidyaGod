    ...
    : QDialog(parent)
{
    ...
    // Validation panel — a persistent box docked beneath the tabs, refreshed by UpdateValidationBox().
    ValidationBox = new QGroupBox("Validation", RightPanel);
    ...
    RightLayout->addWidget(ValidationBox, 0);
